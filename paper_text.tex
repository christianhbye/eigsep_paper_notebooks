...
pixels about zero, approximately 730\,K; because the decomposition is not
centred, the first mode captures the mean antenna temperature spectrum.
...
antenna temperature to one part in $10^{6}$, or 1.82\,mK.
